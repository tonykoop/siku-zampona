(* ============================================================
   ...
   ============================================================
   This file is the v4.3 Tier-1 wolfram-starter.wl stub.
   The full interactive model is in wolfram/instrument-model.wl.

   To open the full notebook:
     Get["wolfram/instrument-model.wl"]

   Or navigate to the wolfram/ directory and open instrument-model.wl
...
(* Load full model *)
(* Get[NotebookDirectory[] <> "wolfram/instrument-model.wl"]; *)
